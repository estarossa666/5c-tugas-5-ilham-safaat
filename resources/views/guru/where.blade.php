...
<body class="container-fluid">
    ...
    <div class="row" style="height: 875px">
        <div class="col-2 maroon h-100 d-inline-block">
            Guruku
        </div>
        <div class="col-10">
                ...
                <table class="table" style="height: 450px">
                    ...
                    <tbody>
                        @foreach ($guru as $g)
                            ...
                            <td>
                                <a href="{{ url('edit-guru',$g->id) }}" class="btn btn-secondary">Edit</a>
                                <a href="{{ route('delete-guru',$g->id) }}" class="btn btn-danger">Delete</a>
                            </td>
                            </tr>
                        @endforeach
                    </tbody>
